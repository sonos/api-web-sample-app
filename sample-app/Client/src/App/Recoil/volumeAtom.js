...
const volumeAtom = atom({
 ...
 default: {
  volumeVal: 0,  // {number} Volume value of currently displayed group. Group volume slider is set to this value
  getStartVolumeFlag: true,  // {boolean} If true, GetGroupVolume is called and current group's volume status is fetched from Sonos API
 },
});
